...
import { restaurantEditorEditViewHandler } from "./restaurantEditorEditViewHandler"
...
export function handlers(dependencies: Dependencies) {
    return {
        ...
        restaurantEditorEditViewHandler: (args: ViewArgs) => restaurantEditorEditViewHandler(args, dependencies),
    }
}
